            ...
            <div className="w-full lg:w-2/3 h-full overflow-y-auto scrollbar-custom p-4 md:p-8 lg:p-12">
                <div className="space-y-12 max-w-4xl mx-auto pb-32">
                    ...
                    <SectionCard number="01" title="Información General" icon={ClipboardList}>
                        ...
                        {/* CRM & Retention Section */}
                        <div className="bg-[#1a1a1a] p-6 rounded-[2rem] border border-[#333] shadow-xl">
                            <h4 className="text-[#F5CB5C] font-bold text-sm uppercase tracking-widest mb-6 flex items-center gap-2 border-b border-[#333] pb-4">
                                <Users className="w-4 h-4" /> Datos Comercial & Retenciones
                            </h4>
                            ...
                            {/* Retention Module */}
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-[#333]">
            ...
            <div className="bg-[#333533] rounded-[2rem] p-8 text-sm space-y-5 border border-[#4A4D4A] shadow-xl relative overflow-hidden">
                ...
                {state.retention.enabled && (
                    <div className="flex justify-between items-center text-[#F5CB5C]/70 border-t border-[#4A4D4A]/50 pt-2">
                        ...
                        <span className="font-mono">- {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', maximumFractionDigits: 0 }).format(finalTotal * (state.retention.percentage / 100))}</span>
                    </div>
                )}
                ...
                <div className="space-y-1">
                    <div className="flex justify-between items-center text-[#E8EDDF] font-medium text-lg">
                        <span>Bruto</span>
                        <span className="font-mono">{new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', maximumFractionDigits: 0 }).format(finalTotal)}</span>
                    </div>
                    {state.retention.enabled && (
